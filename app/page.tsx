    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {hasStarted && (
        <button
          ...
          className="fixed bottom-4 right-4 z-[60] w-12 h-12 flex items-center justify-center rounded-full bg-black/50 hover:bg-black/70 text-white/70 hover:text-white transition-all"
